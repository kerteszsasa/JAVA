 ...
 * spider.
 */
public class ESP8266_default_webpage {
    ...
    for (;;) {
      try {
        ...
        */
        ...
        out.println("<h1>Wifi configuration</h1>");
      //  out.println("<form method=get> SSID:</br><input type=text size=20 name=QSSID value= ></br></br> PSWD:</br><input type=text size=20 name=QPSWD value= ></br></br>  <input type=submit value=Save></form>");   
        out.println("<form method=get> SSID: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type=text size=20 name=QSSID value= ></br></br> Password: <input type=text size=20 name=QPSWD value= ></br></br> Click <input type=submit value=Save> will update the configuration and restart the devide.  </form>");   
  ...
  public static void main(String args[]) {
	  ESP8266_default_webpage ws = new ESP8266_default_webpage();
    ws.start();
  }
}