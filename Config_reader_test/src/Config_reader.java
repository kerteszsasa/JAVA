...
public class Config_reader {
	...
	//
	boolean HTTP_NODE = false;
	int HTTP_NODE_PORT = 0;
	boolean HTTP_NODE_GET = false;
	boolean HTTP_NODE_POST = false;
	//*****************************************************************************************************************************
...
//GET PARAMETERS FROM CONFIG
	   ...
	   if( Configparser("HTTP_NODE").equals("ENABLE") ){
		   HTTP_NODE = true;
	   }
...
*/
	...
	boolean Is_HTTP_NODE(){return HTTP_NODE;}
	int Get_HTTP_NODE_PORT(){return HTTP_NODE_PORT;}
	boolean Is_HTTP_NODE_GET(){return HTTP_NODE_GET;}
	boolean Is_HTTP_NODE_POST(){return HTTP_NODE_POST;}
