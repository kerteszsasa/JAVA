...
//the gui, this is to pass messages to our nice interface
	//TODO public webserver(int listen_port, webserver_starter to_send_message_to) {
	public webserver(int listen_port) {
	//TODOmessage_to = to_send_message_to;
    port = listen_port;
...
//client have to wait real long before it gets any response.
  ...
  private void s(String s2) { //an alias to avoid typing so much!
   //TODO message_to.send_message_to_window(s2);
    System.out.println(s2);
  }

//TODOprivate webserver_starter message_to; //the starter class, needed for gui
